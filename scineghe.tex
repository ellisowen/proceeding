...
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Source Model} & \textbf{Total Flux/ph cm$^{-2}$ s$^{-1}$} & \textbf{Flux in Galactic Region/ph cm$^{-2}$ s$^{-1}$} & \textbf{Flux in Galactic Region/\%}\\\hline
\testit{Fermi} 1FHL Catalog > 10 GeV &  &  & \\\hline
Reference Simulation &  &  & \\\hline
Simulation 1 &  &  &  \\\hline
Simulation 2 &  &  &  \\\hline
\end{tabular}}
